        ...
        <?php   
            ...
            while($row = mysqli_fetch_assoc($select_all_users_query)){   
                ...
                echo "<td><img src='images/users/$user_image' class='img-rounded img-responsive' width='80px'</td>";
                 ...
                 echo "<td><a class='btn btn-success' href = 'users.php?make_admin=$user_id'><span class = 'fa fa-check'></span> Make admin</a></td>";
                echo "<td><a class='btn btn-warning' href = 'users.php?make_subscriber=$user_id'><span class = 'fa fa-times'></span> Make Subscriber</a></td>";
